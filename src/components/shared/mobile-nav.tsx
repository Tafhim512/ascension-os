...
import { LayoutDashboard, Target, Activity, Shield, BookOpen, Settings, Map, Sword } from "lucide-react";
...
export function MobileNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden">
      ...
      <nav className="bg-bg-secondary/90 backdrop-blur-xl border-t border-border/50 px-2 pb-[env(safe-area-inset-bottom)]">
